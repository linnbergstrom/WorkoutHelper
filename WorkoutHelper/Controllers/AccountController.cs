...
namespace WorkoutHelper.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
			//retrive manager object from OwinContext if none exists
            get
            {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
			...
			//uncomment for email confirm
			//if (!UserManager.IsEmailConfirmed(userid))
			//{
			//	ModelState.AddModelError("", "You must confirm Email before logging on.");
			//	return View(model);
			//}
	    ...
	    public async Task<ActionResult> Register(RegisterViewModel model)
	    {
		    if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					var isAdmin = UserManager.Users.Count() == 1;
					//var context = new ApplicationDbContext();
					var context = new WorkoutHelperContext();
		    ...
		    //var sendmail = SendConfirmEmail(model);
